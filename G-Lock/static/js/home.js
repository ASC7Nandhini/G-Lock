var redirect_uri = "http://127.0.0.1:5000/home";
...
if( null != cameraStream ) {
    ...
    fetch("/emotion",
                ...
                .then((data) => {
                    ...
                    {
                        $("#emoji").html("&#128532");
                        $("#sugg").innerhtml("Looks like you're sad.<br>Suggestions to improve your mood");
                        suggestSong(data.emotion);
                        advin.innerHTML = "&#8226;Brisk walking<br>&#8226;Jogging<br>&#8226;Weight training<br>&#8226;Water aerobics<br>&#8226;Swimming"
                    }
                    else if(data.emotion == "surprise")
                    {
                        $("#emoji").html("&#128561");
                        $("#sugg").innerhtml("Looks like you're suprised");
                        suggestSong(data.emotion);
                        advin.innerHTML = "<span style=\"font-size: 50px;\">&#128077;</span><br>"
                    }
                    ...
                    {
                        $("#emoji").html("&#128551");
                        $("#sugg").innerhtml("Looks like you're afraid.<br>Suggestions to improve your mood");
                        suggestSong(data.emotion);
                        advin.innerHTML = "&#8226;breathing<br>&#8226;visualizing<br>&#8226;Be aware of how you feel<br>&#8226;counting<br>&#8226;stay present"
                    }
                    else if(data.emotion == "angry")
                    {
                        $("#emoji").html("&#128545");
                        $("#sugg").innerhtml("Looks like you're angry.<br>Suggestions to improve your mood");
                        suggestSong(data.emotion);
                        advin.innerHTML = "&#8226;Deep Breathing<br>&#8226;Progressive Relaxation<br>&#8226;Boxing<br>&#8226;Brisk Walking<br>&#8226;Weight Lifting"
                    }
                    else if(data.emotion == "disgust")
                    {
                        $("#emoji").html("&#129314");
                        $("#sugg").innerhtml("Looks like you're disgusted.<br>Suggestions to improve your mood");
                        suggestSong(data.emotion);
                        advin.innerHTML = "&#8226;Allow rather than accept<br>&#8226;Respond with flexibility"
                    }
